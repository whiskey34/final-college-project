...
class Recognizer():
    def __init__(self,
                 socketio,
                 facerecognition_model="simple_frozen_graph.pb",
    ...
    def predict(self, frame):
        ...
        for (x, y, w, h) in faces:
            ...
            blob = cv2.dnn.blobFromImage(
                face_img, 1.0, (50, 50), (0, 0, 0), swapRB=True, crop=False)
            ...
            if confidence > 70:
                ...
                label_text = "N/A"
            frame = self.draw_ped(frame, label_text, x, y, x + w,
                                  y + h, color=(0, 255, 255), text_color=(50, 50, 50))
